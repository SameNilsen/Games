...
class MyGameWindow(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.sprite1 = arcade.Sprite("Sprite/Panda.png", center_x=100, center_y=100, scale=0.13)

        self.sprite2 = arcade.Sprite("Sprite/Stan.png", center_x=100, center_y=100, scale=0.8)
        ...
        self.sprite1._set_collision_radius = 1
        self.avstand = False

    def _set_collision_radius(self, collision_radius: float):

        self.sprite1._collision_radius = collision_radius

    def _get_collision_radius(self):

        if not self.sprite1._collision_radius:
            self.sprite1._set_collision_radius = 1
        return self.sprite1._collision_radius
    ...
    def on_update(self, delta_time):
        #print(delta_time)
        if arcade.get_distance_between_sprites(self.sprite1, self.sprite2) < 120:
            print(arcade.get_distance_between_sprites(self.sprite1, self.sprite2))
