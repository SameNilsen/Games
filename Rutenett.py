...
class MyGameWindow(arcade.Window):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(f"{self.seconds//1}", 50, self.height - 20, arcade.color.DARK_RED, 20)
    ...
    def on_update(self, delta_time):
        ...
        player_xy = [self.player_x, self.player_y]
        for o in range(0, len(self.hinder_points_liste)):
            if player_xy == self.hinder_points_liste[o]:
                self.go = False
                self.enter = False
                self.game_over = True
        ...
        if self.drill:
            ...
            for i in range(0, len(self.hinder_points_liste)):
                if drill_xy == self.hinder_points_liste[i]:
                    ...
                    f = self.drill_y
                    print("e, f", e, f)
                    dot = arcade.create_ellipse_filled(e, f, 5, 5, arcade.color.BLUE)
