...
def sjakk_sjekk(brett, x_sjekk, y_sjekk):
    hvit_x = x_sjekk
    hvit_y = y_sjekk
...
def sjakk_matt(brett, hvit_x, hvit_y):
    matt = 8
...
def main():
    ...
    while True:
        ...
        if sjakk_sjekk(brett, hvit_x, hvit_y):
            print("SJAKK MOT HVIT")
            brett[-hvit_y][hvit_x-1] = '⟤'
            if sjakk_matt(brett, hvit_x, hvit_y):
